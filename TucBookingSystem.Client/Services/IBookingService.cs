...
public interface IBookingService
{
    ...
    Task<(bool Success, string Message, BookingDto? Booking)> UpdateBookingAsync(int bookingId, UpdateBookingDto dto);
    ...
    Task<(bool Success, string Message, BookingDto? Booking)> UpdateAsync(int bookingId, int userId, UpdateBookingDto dto);
